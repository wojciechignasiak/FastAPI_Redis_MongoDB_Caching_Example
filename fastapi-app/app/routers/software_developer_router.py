...
from app.database.mongo.repositories.software_developer_repository import SoftwareDeveloperRepository
...
from app.database.redis.repositories.software_developer_cache_repository import SoftwareDeveloperCacheRepository
...
async def create_software_developer_endpoint(software_developer: CreateSoftwareDeveloperModel, 
    ...
    try:
        ...
        software_developer_query: SoftwareDeveloperRepository = SoftwareDeveloperRepository(mongo_collection)
        created_software_developer: SoftwareDeveloperModel = await software_developer_query.create(software_developer)
        software_developer_cache: SoftwareDeveloperCacheRepository = SoftwareDeveloperCacheRepository(redis_client)
